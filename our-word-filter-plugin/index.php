...
/*
  ...
  Description: Replaces a list of words we dont want to show in our content.
  Version 1.0
  Author: Abhishek
...
class OurWordFilterPlugin {
    ...
    function ourMenu(){
        // add_menu_page('Words To Filter', 'Word Filter', 'manage_options', 'ourwordfilter', array($this, 'wordFilterPage'), plugin_dir_url(__FILE__) . 'custom.svg', 50);
